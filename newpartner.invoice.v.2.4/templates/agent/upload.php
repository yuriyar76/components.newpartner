	...
	<div class="col-md-12">
		<div class="btn-group">
			<div class="btn-group" role="group">
				<a href="<?=$arParams['LINK'];?>?mode=add" class="btn btn-warning" id="new_btn"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Новая накладная</a>
			</div>
			<div class="btn-group" role="group">
				<a href="<?=$arParams['LINK'];?>" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"  title="Список накладных">
