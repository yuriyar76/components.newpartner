...
<script type="text/javascript">
	...
	{
		var url = '/search_city.php?type=name_company&company=<?=$arResult['CURRENT_CLIENT'];?>&branch=<?=intval($arResult["CURRENT_BRANCH"]);?>';
	...
	{
		var url = '/search_city.php?type=name_company&company=<?=$arResult['CURRENT_CLIENT'];?>&type_company=259&branch=<?=intval($arResult["CURRENT_BRANCH"]);?>';
...
{
	?>
	<form action="<?=$arParams['LINK'];?>?mode=add" method="post" name="curform" class="form-vertical">
        ...
        <div class="row">
        	 <div class="col-md-3 unit-class2">
				...
				<div class="form-group <?=$arResult['ERR_FIELDS']['COMPANY_SENDER'];?>">
                    ...
                    <select class="form-control selectpicker" name="company_sender_id" onChange="SelectCompanySender();" id="company_sender_id" data-live-search="true">
						<option value="0">
                      		<?
							if (intval($_POST['company_sender_id']) == 0)
							{
						...
						foreach ($arResult['SENDERS'] as $s)
						{
							$ss = ($_POST['company_sender_id'] == $s['id']) ? ' selected' : '';
							?>
                ...
                <div class="row">
                	<div class="col-md-6">
						...
						<div class="form-group <?=$arResult['ERR_FIELDS']['TYPE_DELIVERY'];?>">
                            ...
                            <div class="radio">
                              <label>
                                <input name="TYPE_DELIVERY" value="345" type="radio" <?=($type_delivery == 345) ? 'checked=""' : '';?>>
                                Экспресс 2
                              </label>
                            </div>
                             <div class="radio">
                              <label>
                                <input name="TYPE_DELIVERY" value="346" type="radio" <?=($type_delivery == 346) ? 'checked=""' : '';?>>
                                Экспресс 4
                              </label>
                            </div>
                            <div class="radio">
                              <label>
                                <input name="TYPE_DELIVERY" value="338" type="radio" <?=($type_delivery == 338) ? 'checked=""' : '';?>>
                                Экспресс 8
                              </label>
                            </div>
                            <div class="radio">
                        ...
                        <div class="form-group <?=$arResult['ERR_FIELDS']['WHOSE_ORDER'];?> <?=(($payment == 256) && (($type_pays == 252) || ($type_pays == 253))) ? '' : ' hidden';?>" id="whose_order_block">
								<div class="row">
									<div class="col-md-10">
										...
										<? else : ?>
										<input type="text" class="form-control" name="PAYS" value="<?=$_POST['PAYS'];?>">
										<? endif;?>
									</div>
								</div>
						</div>
        ...
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered" id="calculated_values">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" class="form-control" name="pack_description[0][name]" value="<?=strlen($_POST['pack_description'][0]['name']) ? $_POST['pack_description'][0]['name'] : $type_pack_name;?>" id="pack_description_first"></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="pack_description[1][place]" value="<?=$_POST['pack_description'][1]['place'];?>"></td>
                        ...
                        <tr>
                            ...
                            <th>
                            	<div class="form-group <?=$arResult['ERR_FIELDS']['WEIGHT'];?>">
	                            	<div class="input-group">
	                            		<input type="text" class="form-control" disabled id="total_weight">
	                            		<div class="input-group-addon">кг</div>
	                            	</div>
	                            </div>
                            </th>
            ...
            <div class="col-md-3">
            	<div class="form-group">
                    ...
                    <textarea name="INSTRUCTIONS" class="form-control" style="height:150px; resize:vertical;"><?=($_POST['INSTRUCTIONS']) ?  ($_POST['INSTRUCTIONS']) : $arResult['DEAULTS']['INSTRUCTIONS'];?></textarea>
                </div>
            </div>
        </div>
        <?
